...
test('formatBtc trims float noise and trailing zeros, rounding to 6 dp', () => {
  assert.equal(formatBtc(0.001 + 0.0004), '0.0014');
  assert.equal(formatBtc(0), '0');
  assert.equal(formatBtc(0.00001342), '0.000013');
  // Beyond 6 dp the amount rounds; the CSV export keeps the raw value.
  assert.equal(formatBtc(0.000000499), '0');
});
